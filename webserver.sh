...
#Check if the user running this is ubuntu user and if not exit

person=`whoami`

if [ $person = ubuntu ]
then
	echo "Hello there Mr. UBUNTU! Its nice to meet you."
	echo
...
#Checking the server for internet connection.
	...
	then
		echo "Your connection looks great"
...
#check if apache is installed 
	...
	echo "Sorry you are not authorized to rub this script"
	echo "Please reach out to your admin department for the right access"
...
echo "Do you agree to provide your infromation Y/N"
read agremnt
...
do
        ...
        ans=N
                        ...
                        do
                                ...
                                echo
                                echo
                                echo "Thanks for providing that information"
                                echo "
                                Name: $firstname
                                State: $state
                                Age: $age 
